   ...
   // double baseCost = animal.getBaseFoodCost();
    ...
    do{
        ...
        else //event ==3
        {
            ...
            std::cout<<"Number of Adult penguins: "<<numAuPen<<std::endl;

            int * adultPenguin = new int [numAuPen];
            int j =0;
            for(int i =0; i<numOfPe ; i++) {
                if(arrayOfPe[i].getAge()>=3) {
                    adultPenguin[j] =i;
            ...
            for(int j=0; j<numAuPen ; j++) {

                std::cout<<"Adult Penguin: "<<adultPenguin[j]<<std::endl;
            }
            delete [] adultPenguin;
            ...
            //A Tiger has a baby.
            if(who < numOfTi) {
                std::cout<<"Your tiger has a baby. Congratulations!"<<std::endl;

                arrayOfTi[who].setNumOfBabies(arrayOfTi[who].getNumOfBabies()+1) ;
                numOfTi+=1;
            ...
            //A penguin has 5 babies.
            else if(who>= numOfTi && who < numOfTi+numOfPe) {

                std::cout<<"Your penguin has 5 babies. Congratulations!"<<std::endl;

                arrayOfPe[who-numOfTi].setNumOfBabies(arrayOfPe[who-numOfTi].getNumOfBabies()+5);
                numOfPe +=5;
                ...
                for(int i=0; i<5; i++){
                    arrayOfPe[numOfPe-5+i] = Penguin(0, penCost, 0, penguin.getBaseFoodCost(), penguin.getPayoff());
                }
            ...
            {
                std::cout<<"Your Turtle has 10 babies.Congratulations!"<<std::endl;
                arrayOfTur[who -(numOfTi + numOfPe)].setNumOfBabies(arrayOfTur[who -(numOfTi + numOfPe)].getNumOfBabies()+10);
                numOfTu +=10;
                ...
                for(int i=0; i<10; i++) {
                    arrayOfTur[numOfTu-10+i] = Turtle(0, turCost, 0, turtle.getBaseFoodCost(), turtle.getPayoff());
                }
            }
        ...
        double todayAIncome =numOfTi*tiger.getPayoff()+numOfPe*penguin.getPayoff()+numOfTu*turtle.getPayoff();
        ...
        std::cout<<"Currently, you have "<<numOfTi<<" Tigers, "<<numOfPe<<" Penguins, "<<numOfTu<<" Turtles"<<std::endl;
        ...
        if(buyNew==1) {
            ...
            std::cout<<"After the purchase now you have "<<numOfTi<<" Tigers, "<<numOfPe<<" Penguins, "<<numOfTu<<" Turtles"<<std::endl;
        }
